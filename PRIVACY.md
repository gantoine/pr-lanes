...
when *Remember per repository* is turned on.
...
your own account, and the developer has no access to it.

## What it reads

The extension reads the GitHub page you are looking at to work out which comments were
written by bots. Nothing it reads is stored or sent anywhere. It is used only to show or
hide rows on the page in front of you, and the page itself is never modified for anyone
else.
