(function () {
  ...
  function buildBar() {
    ...
    element.innerHTML = [
      ...
      '<button type="button" class="prlanes-tab" data-lane="human" title="Humans — press h to cycle lanes"><span class="prlanes-dot prlanes-dot--human"></span><span class="prlanes-icon"><svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"><circle cx="8" cy="4.25" r="3.25"></circle><path d="M8 9c-3.2 0-5.75 1.9-5.75 4.25 0 .41.34.75.75.75h10c.41 0 .75-.34.75-.75C13.75 10.9 11.2 9 8 9Z"></path></svg></span><span class="prlanes-label">Humans</span></button>',
      '<button type="button" class="prlanes-tab" data-lane="bot" title="Bots — press h to cycle lanes"><span class="prlanes-dot prlanes-dot--bot"></span><span class="prlanes-icon"><svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M8 1a.75.75 0 0 1 .75.75V3h2.75A2.5 2.5 0 0 1 14 5.5v5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 10.5v-5A2.5 2.5 0 0 1 4.5 3h2.75V1.75A.75.75 0 0 1 8 1Zm-2.25 5.5a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5Zm4.5 0a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5Z"></path></svg></span><span class="prlanes-label">Bots</span></button>',
      '<button type="button" class="prlanes-tab" data-lane="all" title="All — press h to cycle lanes"><span class="prlanes-icon"><svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"><rect x="2" y="3.25" width="12" height="1.75" rx=".875"></rect><rect x="2" y="7.125" width="12" height="1.75" rx=".875"></rect><rect x="2" y="11" width="12" height="1.75" rx=".875"></rect></svg></span><span class="prlanes-label">All</span></button>',
      '</div>',
